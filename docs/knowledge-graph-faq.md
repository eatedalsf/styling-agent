...
|---|---|---|---|---|
| 1 | **Schema graph** | `graph/graph.json`, `graph/schema.md` | The static abstract model: 9 entity types, 17 relations. Tells reviewers *how* Wearly thinks. | `pyvis` → `vis-network.js`, embedded in the **Before / After** section of the app, and as a Mermaid diagram in `graph/render.md`. |
