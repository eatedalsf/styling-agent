...
**Verified citations:** Itten, J. (1961). *Kunst der Farbe* / *The Elements of Color* (English ed. 1970, Van Nostrand Reinhold / Wiley); Munsell, A. H. (1905). *A Color Notation* (public domain via Project Gutenberg #26054); ISO 11664-4:2008 *Colorimetry — Part 4: CIE 1976 L*a*b* Colour space*. These are the foundational frameworks Wearly's named palettes draw on as background — Wearly does not compute CIE distances at runtime. See `docs/evidence-and-references.md` §3.3 for full citations and the relationship to Wearly's rule.
**Pending verification:** Any peer-reviewed perceptual-psychology study on skin-tone × garment-color preference would further strengthen this rule pack.
